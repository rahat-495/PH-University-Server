...
router.post('/create-student', sendImageToCloudinary_1.upload.single("file"), user_utils_1.parseTextDataToJsonData, (0, validateRequest_1.default)(student_validation_1.studentValidations.createStudentValidationSchema), (0, auth_1.default)('admin'), user_controllers_1.userControllers.createStudent);
router.post('/create-faculty', sendImageToCloudinary_1.upload.single("file"), user_utils_1.parseTextDataToJsonData, (0, auth_1.default)('admin'), (0, validateRequest_1.default)(faculty_validation_1.facultyValidations.createFacultyValidationSchema), user_controllers_1.userControllers.createFaculty);

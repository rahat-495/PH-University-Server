...
router.put('/:courseId/remove-faculties', (0, validateRequest_1.default)(course_validation_1.courseValidations.facultiesWithCourseValidationSchema), course_controllers_1.courseControllers.removeFacultiesWithCourse);
router.delete('/:courseId/assign-faculties', (0, validateRequest_1.default)(course_validation_1.courseValidations.facultiesWithCourseValidationSchema), course_controllers_1.courseControllers.assignFacultiesWithCourse);
